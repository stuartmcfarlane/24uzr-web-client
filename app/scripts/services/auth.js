      ...
      return {
        ...
        function ($rootScope, $location, $route, $injector) {
          ...
          return {
             ...
             * @ngdoc function
             * @methodOf ngSeed.services:$auth
             * @return {Promise} the promise your user service resturns on loadUserList
             */
            loadUserList: function () {
              if(currentUser && currentUser.id) {
                return userService.getUserList().then(function (list) {
                  userList = list;
                  $rootScope.$broadcast('$auth:loadUserListSuccess');
                });
              }
            },
